...
/**
 * Extend FormButtonProps with ComponentPropsWithoutRef<"button"> to pass any button attributes to the component as props
 */
...
export const FormButton = ({
  ...
  return (
    <button
      ...
      className={`relative tracking-widest disabled:opacity-70 disabled:cursor-not-allowed rounded-lg transition w-full ${outline
