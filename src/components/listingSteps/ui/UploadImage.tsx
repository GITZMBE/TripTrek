...
export const UploadImage = ({ unregister, setValue, watch, setError, clearErrors, errors }: UploadImageProps) => {
  ...
  const uploadImage = async (file: File) => {
    try {
      ...
      //   return savedImage;
      // }
      setValue("image", 'https://images.unsplash.com/photo-1594069758873-e79e9075eb7d?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
    } finally {
      setIsLoading(false);
    }
  };
